...
- Solution 2: For existing infra us a two-phase migration pattern with the use of dummy exports

<div style="padding:5px;  border-left: 3px solid rgba(72, 192, 3, 1);">
<strong>Best Practice:</strong> Try to avoid cross stack reference where possible. The application stack pattern helps already.
</div>
...
<div style="padding:5px;  border-left: 3px solid rgba(60, 147, 247, 1);">
<strong>Info:</strong> The following errors can only be observed when running the deployment against a deployed CloudFormation stack. A `cdk diff` does not surface this error message.
</div>
...
<div style="padding:5px;  border-left: 3px solid rgba(72, 192, 3, 1);">
<strong>Recommendation:</strong> Use this even though it has some drawbacks. See after code excerpts.
</div>
